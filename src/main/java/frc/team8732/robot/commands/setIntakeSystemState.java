...
public class setIntakeSystemState extends CommandBase {
  /** Creates a new setIntakeSystemState. */
  Intake mIntake = Intake.getInstance();
  IntakeSystemState systemState;
  public setIntakeSystemState(IntakeSystemState systemState) {
    this.systemState = systemState;
  }

  // Called when the command is initially scheduled.
  @Override
  public void initialize() {mIntake.setSystemState(systemState);}
