...
public class FiveBallAutoMode extends AutoModeBase {
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        runAction(new WaitAction(.75)); // Wait to spin up and release
        ...
        runAction(new ParallelAction(List.of(
            ...
            new SeriesAction(List.of(
                ...
                new WaitAction(1.5), // Shoot Timeout
        ...
        runAction(new WaitAction(.5)); // Intake
        ...
        runAction(new IntakeSystemStateAction(IntakeSystemState.INTAKING));
        runAction(new DriveTrajectoryAction(TrajectoryGenerator.getInstance().getTrajectorySet().ShootPoseToBall3));
        runAction(new ParallelAction(List.of(
            new SystemSetCalculatedShotAction(), // AIM to goal and set calc RPM + Hood
            new SeriesAction(List.of(
                new WaitAction(.25), // Spin Up
